...
var TopicPublisher = function (solaceModule, topicName) {
    ...
    publisher.connect = () => new Promise((resolve) => {
        // create session
        try {
        ...
        publisher.session.on(solace.SessionEventCode.UP_NOTICE, (sessionEvent) => {
    ...
    publisher.publish = (m) => {
        ...
        console.log('Publishing message "' + m + '" to topic "' + publisher.topicName + '"...');
        // pub msg
        try {
